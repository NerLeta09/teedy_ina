pipeline {
    ...
    environment {
        ...
        DOCKER_IMAGE = 'nerleta09/teedy_ina' // Your Docker Hub username and repository's name
        ...
        stage('Build') {
            steps {
                checkout scmGit(
                    ...
                    extensions: [],
                    userRemoteConfigs: [[url: 'https://github.com/NerLeta09/teedy_ina.git']] // Your GitHub repository
                )
